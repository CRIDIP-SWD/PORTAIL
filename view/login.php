...
<div id="login-container" class="animation-fadeIn">
        ...
        <form action="<?= ROOT,CONTROL; ?>client.php" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            ...
            <div class="form-group form-actions">
                ...
                <div class="col-xs-8 text-right">
                    <button type="submit" class="btn btn-sm btn-primary" name="action" value="connexion"><i class="fa fa-angle-right"></i> Connection</button>
                </div>
            </div>
            <div class="form-group">
    ...
    <footer class="text-muted text-center">
        <small><span id="year-copy"></span> &copy; <a href="http://goo.gl/TDOSuC" target="_blank">ProUI 3.0</a></small>
    </footer>
    <!-- END Footer -->
</div>
<!-- END Login Container -->
